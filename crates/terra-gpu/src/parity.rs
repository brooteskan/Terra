...
/// pull of Smooth (#114) and Pinch (#115) is transcendental-free (nine same-order
/// adds and a divide, plus one extra multiply for Pinch's 1.25 gain), so neither
/// widens the worst case — which stays dominated by the distance stamps. Measured
/// worst case is ~6.5e-5 m over the 14-kind stroke set; this holds portable headroom.
...
| `authoring.sculpt-strokes` | Per-sample stroke kinds, Smooth/Pinch, and distance stamps, supported blend/mask | 0.001 | 0.00001 |\n\
