...
/// and Coastline's lower-and-blend), so none widens the worst case — which stays
/// dominated by the distance stamps. Measured worst case is ~6.5e-5 m over the 15-kind
/// stroke set; this holds portable headroom.
